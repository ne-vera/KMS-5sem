function Sim(sldrId) {
	...
	this.leftArrow = this.sldrRoot.querySelector('div.view-slider-arrow-left');
...
Sim.initialize = function(that) {
	...
	if(that.options.dots) {  // инициализация индикаторных точек
		...
		for(let i=0; i<that.elemCount; i++) {
			sum += '<span class="view-dot"></span>'
		};
		that.indicatorDots.innerHTML = sum;
		that.indicatorDotsAll = that.sldrRoot.querySelectorAll('span.view-dot');
